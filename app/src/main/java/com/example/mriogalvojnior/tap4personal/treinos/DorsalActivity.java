...
import com.example.mriogalvojnior.tap4personal.treinos.adaptertreinos.GrupoMuscularAdapter;
import com.viewpagerindicator.PageIndicator;

import java.util.List;


public class DorsalActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {

    private ViewPager pager;
    private PageIndicator indicator;
    private DorsalAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Exercícios de Dorsal");

        pager = (ViewPager) findViewById(R.id.viewPager);
        indicator = (PageIndicator) findViewById(R.id.indicator);
        adapter = new DorsalAdapter(getSupportFragmentManager());
