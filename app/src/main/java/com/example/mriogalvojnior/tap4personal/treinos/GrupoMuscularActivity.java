...
public class GrupoMuscularActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Exercícios de Peitoral");

        pager = (ViewPager) findViewById(R.id.viewPager);
        indicator = (PageIndicator) findViewById(R.id.indicator);
        adapter = new GrupoMuscularAdapter(getSupportFragmentManager());
    ...
    private void compartilharTreino() {
        ...
        int i = 1;
        text.append("TREINO DE PEITORAL: \n\n");
        for (String p : list) {
