 ...
 */
public class GrupoMuscularAdapter extends FragmentPagerAdapter implements IconPagerAdapter {

    private IsoladosFragment isoladosFragment;
    private BisetFragment bisetFragment;
    ...
    public GrupoMuscularAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int position) {
        switch (position){
            case 0:
                isoladosFragment = new IsoladosFragment();
                return isoladosFragment;
            case 1:
                bisetFragment =  new BisetFragment();
